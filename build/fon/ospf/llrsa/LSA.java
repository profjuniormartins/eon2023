...
public class LSA extends Message implements Comparable<LSA>{
	/** The total length, in bytes, of a OSPF IP Header */
	public static final int IP_HEADER_LENGTH = 20;	
	/** The total length, in bytes, of a OSPF Header */
	public static final int OSPF_HEADER_LENGTH = 24;	
	/** The total length, in bytes, of a LSA Header */
	...
	public LSA(String aId, String sourceId, String destinationId, String nodeLSA,  LinkState adv) {
		super(aId, Message.Type.LSA, sourceId, destinationId, (IP_HEADER_LENGTH + OSPF_HEADER_LENGTH + LSA_HEADER_LENGTH + adv.getLength()), 1);
		this.linkState = adv;
	...
	/**
	 * Returns the number of bytes other than the IPv4 header and LSA header (source
	...
	public int getLength() {
		int linkStateLength = linkState.getLength();
		return 	IP_HEADER_LENGTH + OSPF_HEADER_LENGTH + LSA_HEADER_LENGTH + linkStateLength;
	}
