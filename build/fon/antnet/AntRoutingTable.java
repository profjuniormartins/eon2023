...
public class AntRoutingTable extends LocalRoutingTable {
	 ...
	 */
	public AntRoutingTable(String source, double aConfidence, double firstWeight, double secondWeight, double aAmplifier, double aAlpha, double factor, boolean aDeterministic) {
		super(source);
	...
	public String nextHop(Message ant, LinkedHashMap<String,FlexiLink> flexiLinks) {
		...
		return AntFON.select(neighborhood,flexiLinks,(Ant)ant,alpha,powerFactor);
	}
