 ...
 *
 */
public class MultipleLinearConfig {
	...
	public static void readFiles2(String file, String fileVariable1, String fileVariable2) {
		...
		try {
			...
			//for each variable value do
			int index = 0; //index for getting the other values
			for (String value1: values1) {
				String value2 = values2.get(index);
				//Create the new file
//				File output = new File(preffix+"_V"+value1+".xml"); 
				File output = new File(preffix+"_A"+value1+"M"+value2+".xml");				output.createNewFile();
				//Create the writer
				FileWriter writer;
				writer = new FileWriter(output);
				//Now read the configuration file
	...
	public static void readFiles3(String file, String fileVariable1, String fileVariable2, String fileVariable3) {
		...
		try {
			...
			for (String value1: values1) {
				...
				//Create the new file
				String newFile = preffix+"_V"+value1+".xml";
