...
public class Message {
	...
	/** 
	 * Creates a new Message object only to use in ACO Based Algorithm (implements TTL in the ACO Based Ant). 
	 * 
	 * @param aId The identification of the message.
	 * @param aType The type of the message.
	 * @param sourceId The source identification of this message.
	 ...
	 * @param aLength The length of this message.
	 */
	public Message(String aId, Type aType, String sourceId, String destinationId, int aLength) {
		this.id = aId;
		this.type = aType;
		this.source = sourceId;
		this.destination = destinationId;
